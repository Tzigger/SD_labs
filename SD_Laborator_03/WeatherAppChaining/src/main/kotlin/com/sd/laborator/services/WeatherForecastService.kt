...
/**
 * =====================================================================
 * SERVICIUL DE PROGNOZA METEO – pattern INLANTUIRE (Chaining)
 * =====================================================================
 *
 * Rol in lant:  ULTIMUL  (TAIL of chain)
 * Primeste de la: LocationSearchService
 * Apeleaza:       nimeni (capatul lantului)
 *
 * Functionare:
 *   1. Primeste coordonatele geografice de la LocationSearchService.
 *   2. Interogheaza Open-Meteo Forecast API pentru datele meteo.
 *   3. Construieste obiectul WeatherForecastData si il returneaza.
 *   4. Rezultatul urca inapoi prin lant pana la controller.
 *
 * Principiu de inlantuire:
 *   WeatherForecastService este capatul lantului – nu cunoaste
 *   niciun alt serviciu. Returneaza datele brute (POJO) catre cel
 *   care l-a apelat (LocationSearchService).
 *
...
class WeatherForecastService(private val timeService: TimeService) : WeatherForecastInterface {
    ...
    override fun getForecastData(latitude: Double, longitude: Double, locationName: String): WeatherForecastData {
        println("[WeatherForecastService] Obtinere date meteo pentru: $locationName ($latitude, $longitude)")
        ...
        // Date zilnice (min/max temperatura)
        ...
        // Umiditate medie din datele orare (primele 24 de ore)
        ...
        println("[WeatherForecastService] Date obtinute. Capatul lantului atins – returneaza rezultatul.")
    ...
    /**
     * Converteste codurile WMO de vreme (folosite de Open-Meteo)
     * intr-o descriere lizibila in limba romana.
     */
