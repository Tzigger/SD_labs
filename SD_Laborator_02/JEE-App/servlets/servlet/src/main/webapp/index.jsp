...
<html>
	...
	<body>
		...
		<br />
		<a href="./fetch-student-list">Afisare lista studenti (cu optiuni de actualizare si stergere)</a>
		<hr />
		<h3>Monitorizare baza de date</h3>
		<a href="./monitor">Configurare si pornire monitorizare</a>
		<br />
		<a href="./monitor?action=alarms">Vizualizare alarme</a>
	</body>
</html>